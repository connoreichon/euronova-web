...
- **SUPERFICIE** (tabs `[data-surface]`): **Interior** (`interior.jpg` = salón nórdico luminoso `living-room-2155376`) o **Exterior** (`fachada.jpg` = fachada mediterránea, **con el cartel/placa clonado fuera** — el cliente no quiere letras en las fotos). **Esmalte/metal** = tab deshabilitado "pronto" (⚠ PENDIENTE: la verja de forja bonita es calada y contra follaje/setos oscuros → imposible separar el hierro del fondo por luminancia/saturación; hace falta metal contra fondo UNIFORME claro (cielo puro o pared blanca), o que el cliente pase una foto).
